...
def main(argv: Sequence[str] | None = None) -> int:
    settings = Settings.from_env()
    parser = argparse.ArgumentParser(description="Collect Coupang shopping prices")
    ...
    result = run_coupang(
        observed_date, target=arguments.item, headful=arguments.headful
    )
